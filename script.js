...
document.addEventListener('DOMContentLoaded', () => {
            ...
            async function handleForwardLookup() {
                ...
                try {
                    ...
                    // Lấy dữ liệu thay đổi thôn/xóm nếu có
                    const {
                        events,
                        village_changes
                    } = data;
                    ...
                    try {
                        ...
                        if (data && data.length > 0) {
                            ...
                            const oldUnitsFullAddresses = data.map(record => {
                                ...
                                //TẠM ẨN CÁC BIẾN KHÔNG SỬ DỤNG THAY BỞI fullOldAddress VÀ oldCodes
                                ...
                                // GHI CHÚ THAY ĐỔI: Gọi hàm renderVillageChanges cho từng xã cũ
