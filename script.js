document.addEventListener('DOMContentLoaded', () => {
 ...
 // QUICK SEARCH
    ...
    // GHI CHÚ: Thêm window. để chia sẻ với quick-script
    window.localize = function(name, en_name) {
